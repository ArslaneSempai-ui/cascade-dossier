...
3 packages are installed under `node_modules/`, development dependencies
...
0 of them are binaries whose package name carries
the platform (none).
...
| --- | --- | --- |
| Permissive | 3 | Attribution, nothing else. |
| With obligations | 0 | Permitted in a proprietary product, under conditions, set out below. |
